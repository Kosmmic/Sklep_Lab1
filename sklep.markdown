...
Wyjaśnienia ról (Administrator vs Kierownik), usuwanie kont, RODO: zobacz [PROJEKT-notatki.md](PROJEKT-notatki.md).
...
classDiagram
    ...
    %% Uwaga: Administrator i Kierownik łączą się z ZarzadzanieLogistykaKierownik –
    %% to może być nadzór awaryjny (Admin) vs bieżąca logistyka (Kierownik).
    %% W Javie możesz rozdzielić interfejsy, jeśli chcesz ostrego podziału.
...
classDiagram
    ...
    %% Pełne atrybuty metod: sklep-zone-03-encje.md
    %% Tu: skrócone pola, żeby widać było „co jest w encji” bez rozrostu diagramu.
